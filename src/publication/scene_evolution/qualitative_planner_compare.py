...
Load logs
"""
plot_files = {'lvt':['20221125-03-26-50'], \
                 'qmdp':['20221125-03-36-14'],
                 'mcts':['20221125-03-41-07'],
                 'omniscient':['20221125-03-15-54'],
                 'mcts_mean':['20221125-03-43-08'],
                 'rule_based':['20221125-03-13-12'],
    ...
    with open(save_to+file_name+'.pickle', 'rb') as handle:
        ...
        for car_id, state_vals in logged_states.items():
            if car_id != 'sdv':
                ...
                logged_states[car_id] = logged_states[car_id][:logged_s   tates['sdv'].shape[0], :]
