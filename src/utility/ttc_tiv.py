...
_ = plt.hist(ttcs, 100,ec="black", fc="darkblue")
plt.ylabel('Histogram count', labelpad=-2)
plt.xlabel('TTC (s)')
percentile_50 = np.quantile(ttcs, 0.5)
percentile_10 = np.quantile(ttcs, 0.1)

plt.axvline(percentile_50, color='red')
plt.text(percentile_50, 105, '50th percentile', color='red', size=14, horizontalalignment='left')
plt.axvline(percentile_10, color='red')
plt.text(percentile_10, 105, '10th percentile', color='red', size=14, horizontalalignment='center')
...
_ = plt.hist(tivs, 100,ec="black", fc="darkblue")
plt.ylabel('Histogram count')
plt.xlabel('TIV (s)')
percentile_50 = np.quantile(tivs, 0.5)
percentile_10 = np.quantile(tivs, 0.1)
plt.axvline(percentile_50, color='red')
plt.text(percentile_50, 410, '50th percentile', color='red', size=14, horizontalalignment='left')
plt.axvline(percentile_10, color='red')
plt.text(percentile_10, 410, '10th percentile', color='red', size=14, horizontalalignment='center')
